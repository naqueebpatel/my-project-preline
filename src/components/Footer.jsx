  ...
  return (
    <footer className="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
      ...
      <div className="text-center">
        ...
        <div className="mt-3">
          <p className="text-gray-500">Developed and Managed By <a className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" href="#">CNC</a> Team.</p>
