...
const Footer = () => {
  ...
  <div className="text-center">
    ...
    <div className="mt-3">
      <p className="text-gray-500">Developed and Managed By <a className="font-semibold text-blue-600 hover:text-blue-700 dark:text-blue-500 dark:hover:text-blue-400" href="#">CNC</a> family.</p>
