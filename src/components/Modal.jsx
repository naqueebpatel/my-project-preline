...
const Modal = ({ handleModal, data }) => {
    return (
        <div className="fixed inset-0 bg-black bg-opacity-20 backdrop-blur-sm flex justify-center items-center z-50">
            <div className={`w-full max-w-[90%] md:max-w-[600px] bg-white border z-[80] border-gray-200 rounded-xl shadow-sm pointer-events-auto dark:bg-gray-800 dark:border-gray-700`}>
                <div className="p-4 sm:p-7">
                    ...
                    <div className="mt-8 sm:mt-10 divide-y divide-gray-200 dark:divide-gray-700">
                        {data?.labels?.map((label, index) => (
                            <div className="flex gap-x-7 py-1 first:pt-0 last:pb-0" key={index}>
